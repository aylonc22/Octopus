...
return(
        <div className = "Edit-Page">
                <div className = "Tail-Component">
                <div className = "DataCard">
                <div className = "Table-Name">Tail</div>
                <div className = "Row"><div className = "Header-Cell"> id</div> <div className = "Header-Cell"> Type</div> </div>
                {[...Array(35)].map((i,index)=><div key = {index} className = "Row">
                ...
                {/*
                <div className = "Tail-Component"> <Table getAllTable = {tail_api.getAllTail()} insertToTable = {(item)=>tail_api.insertTail(item)} secondary = "Type" secondaryH = "סוג" ID_Limit = "3"/>         
